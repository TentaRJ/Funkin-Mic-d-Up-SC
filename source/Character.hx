	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-sunset':
				...
				flipX = true;
			case 'asha':
				frames = Paths.getSparrowAtlas("characters/asha_day", 'shared');
				animation.addByPrefix('idle', 'asha idle', 24, false);
				animation.addByPrefix('singUP', "asha up note", 24, false);
				animation.addByPrefix('singDOWN', "asha down note", 24, false);
				animation.addByPrefix('singLEFT', "asha left note", 24, false);
				animation.addByPrefix('singRIGHT', "asha right note", 24, false);
